...
class City extends Component {
   ...
   categoryClickHandler = category => {
      let criteria = [...this.state.criteria]
         .filter(cri => cri.criteriaName !== "category")
      let newCriteria = {
   ...
   removeCriteriaHandler = (index, name) => {
      let criteria = [...this.state.criteria]
      criteria.splice(index, 1)
      this.setState({ criteria })
      name === 'category' && this.setState({ categorySelected: null })
         ...
         <div className="container-fluid" style={{ marginTop: 30, marginBottom: 30 }}>
            ...
            <div className="row">
               ...
               <div className="col-12 col-md-9">
                  ...
                  <SearchCriteria criteria={this.state.criteria}
                     removeCriteriaHandler={(index, name) => this.removeCriteriaHandler(index, name)}
